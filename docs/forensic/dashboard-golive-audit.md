...
| AmarktAI Assistant assistant widgets | disabled by default in layout | `NEXT_PUBLIC_AmarktAI Assistant_ENABLED=true` | Not delete | Hidden by default |
