...
import { ArrowLeft, Boxes, Loader2, Sparkles } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-[#0d1a2e] to-[#060d1b] p-6">
        ...
        <p className="mt-2 max-w-3xl text-sm text-slate-400">Create a per-app AI package. No global default: each app gets its own capabilities, providers, models, budgets and permissions.</p>
      </div>
