...
export default function CampaignsPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        label="Campaigns"
        title="Campaign Workflow Results"
        description="Track website scrape, brand extraction, RAG, plan, generated items, approvals, assets, publishing, and learning signals."
        badge={
