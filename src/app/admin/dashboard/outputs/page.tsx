            ...
            <article key={artifact.id} className="overflow-hidden rounded-2xl border border-slate-700/60 bg-slate-900/60">
              ...
              <div className="space-y-4 p-4">
                ...
                <dl className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
                  ...
                  <Meta label="Provider" value={artifact.provider || 'Not recorded'} />
                  <Meta label="Model" value={artifact.model || 'Not recorded'} />
      ...
      {selected && (
        <section className="rounded-2xl border border-cyan-400/30 bg-slate-950 p-5">
          ...
          {(selected.executionId || selected.jobId) && (
            <a className="mt-4 inline-block text-sm font-bold text-cyan-300" href={`/admin/dashboard/jobs-approvals?executionId=${encodeURIComponent(selected.executionId || '')}`}>
