...
export const AI_CAPABILITY_TAXONOMY: readonly AiCapabilityDefinition[] = [
  ...
  capability({ id: 'music_generation', label: 'Music Generation', group: 'music', inputTypes: ['text', 'lyrics', 'style'], outputTypes: ['music'], description: 'Generate a real track or trackable provider job.', providers: ['genx', 'huggingface'], executableProviders: ['genx', 'huggingface'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/admin/music-studio', status: 'working', blocker: null, requiredScope: 'ai:music:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: true }),
