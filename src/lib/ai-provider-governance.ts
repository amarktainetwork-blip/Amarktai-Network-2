...
export const AI_PROVIDER_GOVERNANCE: readonly ProviderGovernanceEntry[] = [
  ...
  },
  {
    ...
    envVar: 'GITHUB_PAT',
    envVarAliases: ['GITHUB_PAT', 'GITHUB_TOKEN'],
    status: 'core',
    setupGroup: 'primary',
  ...
  },
  {
    ...
    status: 'core',
    setupGroup: 'primary',
    reason: 'Optional specialist multimodal provider, separate from Xiaomi MiMo.',
    capabilities: ['chat', 'creative', 'reasoning', 'coding', 'image_generation', 'video_generation', 'voice_tts', 'voice_stt'],
    coveredByGenX: false,
    wired: true,
    showInPrimarySetup: true,
    defaultCostRole: 'cheap',
    notes: 'Accepts MINIMAX_API_KEY. Xiaomi MiMo is configured separately. Music generation is post-launch and is not exposed as available.',
  },
  {
    key: 'mimo',
    ...
    status: 'core',
    setupGroup: 'primary',
    reason: 'MiMo V2.5-compatible tool agents, speech, multimodal understanding, web search, and code-tool workflows.',
    capabilities: ['chat', 'creative', 'reasoning', 'coding', 'voice_tts', 'voice_stt', 'research'],
    coveredByGenX: false,
    wired: true,
    showInPrimarySetup: true,
    defaultCostRole: 'cheap',
    notes: 'MiMo is a Xiaomi provider and is not an alias for MiniMax.',
  },
  {
    key: 'deepseek',
  ...
  },
  {
    ...
    integrationKey: 'local-crawler',
    envVar: 'QDRANT_URL',
    status: 'core',
    setupGroup: 'primary',
    reason: 'Playwright, Scrapy, and Trafilatura provide rendered and depth crawling without an external crawl API.',
  ...
  },
  {
    ...
    status: 'active_optional',
    setupGroup: 'specialist',
    reason: 'Specialist premium voice fallback for AmarktAI Assistant and future apps.',
  ...
  {
    key: 'openai',
    displayName: 'OpenAI compatibility fallback',
