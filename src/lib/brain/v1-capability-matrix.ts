...
export const AI_CAPABILITY_TAXONOMY: readonly AiCapabilityDefinition[] = [
  ...
  capability({ id: 'automatic_speech_recognition', label: 'Automatic Speech Recognition', group: 'audio', inputTypes: ['audio'], outputTypes: ['transcript'], description: 'Transcribe uploaded audio and persist the transcript.', providers: ['genx', 'groq', 'together', 'huggingface'], executableProviders: ['genx', 'groq', 'together', 'huggingface'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/stt', status: 'working', blocker: null, requiredScope: 'ai:audio:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: false }),
  ...
  capability({ id: 'music_generation', label: 'Music Generation', group: 'music', inputTypes: ['text', 'lyrics', 'style'], outputTypes: ['music'], description: 'Generate playable music audio and persist it as an artifact.', providers: ['genx', 'huggingface'], executableProviders: ['genx', 'huggingface'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/admin/music-studio', status: 'working', blocker: null, requiredScope: 'ai:music:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: true }),
