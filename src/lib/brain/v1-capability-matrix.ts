...
const textProviders: ApprovedDirectProviderId[] = ['genx', 'mimo', 'groq', 'together', 'huggingface']
const visionProviders: ApprovedDirectProviderId[] = ['genx', 'mimo', 'huggingface']
const imageProviders: ApprovedDirectProviderId[] = ['genx', 'together', 'huggingface']
...
export const AI_CAPABILITY_TAXONOMY: readonly AiCapabilityDefinition[] = [
  capability({ id: 'chat', label: 'Chat', group: 'text', inputTypes: ['text', 'conversation'], outputTypes: ['text'], description: 'Conversational responses with app context.', providers: textProviders, executableProviders: ['genx', 'mimo', 'groq', 'together', 'huggingface'], executableEndpoint: '/api/brain/request', status: 'working', blocker: null, requiredScope: 'ai:text:execute', exposeToConnectedAppsV1: true, createsArtifact: false, longRunning: false }),
  capability({ id: 'reasoning', label: 'Reasoning', group: 'agents_or_planning', inputTypes: ['text', 'context'], outputTypes: ['text', 'plan'], description: 'Multi-step reasoning and structured planning.', providers: ['genx', 'mimo', 'groq', 'together'], executableProviders: ['genx', 'mimo', 'groq', 'together'], executableEndpoint: '/api/brain/request', status: 'working', blocker: null, requiredScope: 'ai:text:execute', exposeToConnectedAppsV1: true, createsArtifact: false, longRunning: false }),
  capability({ id: 'research', label: 'Research', group: 'agents_or_planning', inputTypes: ['text', 'url'], outputTypes: ['research_result', 'sources'], description: 'Structured research using the canonical capability router.', providers: ['genx', 'mimo', 'groq', 'together'], executableProviders: ['genx', 'mimo', 'groq', 'together'], executableEndpoint: '/api/brain/research', status: 'working', blocker: null, requiredScope: 'ai:research:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: false }),
  capability({ id: 'text_generation', label: 'Text Generation', group: 'text', inputTypes: ['text', 'context'], outputTypes: ['text'], description: 'Generate app-facing text and structured copy.', providers: textProviders, executableProviders: ['genx', 'mimo', 'groq', 'together', 'huggingface'], executableEndpoint: '/api/brain/request', status: 'working', blocker: null, requiredScope: 'ai:text:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: false }),
  ...
  ...([
    ...
    executableProviders: ['huggingface'],
  ...
  capability({ id: 'embeddings', label: 'Embeddings', group: 'text', inputTypes: ['text', 'text_array'], outputTypes: ['vector', 'vector_array'], description: 'Create text embeddings for retrieval and similarity.', providers: ['genx', 'huggingface', 'together'], executableProviders: ['huggingface', 'genx'], executableEndpoint: '/api/brain/embeddings', status: 'working', blocker: null, requiredScope: 'ai:data:execute', exposeToConnectedAppsV1: true, createsArtifact: false, longRunning: false }),
  ...
  capability({ id: 'text_to_image', label: 'Text to Image', group: 'computer_vision', inputTypes: ['text'], outputTypes: ['image'], description: 'Generate an image from a text prompt.', providers: imageProviders, executableProviders: ['genx', 'together', 'huggingface'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/image', status: 'working', blocker: null, requiredScope: 'ai:image:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: false }),
  ...
  capability({ id: 'image_to_video', label: 'Image to Video', group: 'video', inputTypes: ['image', 'text'], outputTypes: ['video'], description: 'Generate video from a required source image.', providers: ['genx', 'together', 'huggingface'], executableProviders: ['genx'], executableEndpoint: '/api/brain/video-generate', status: 'partially_wired', blocker: 'No remaining launch provider has a live-proven source-image video contract. Together remains endpoint-gated and Hugging Face remains specialist-endpoint gated.', requiredScope: 'ai:video:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: true }),
  capability({ id: 'image_text_to_video', label: 'Image and Text to Video', group: 'video', inputTypes: ['image', 'text'], outputTypes: ['video'], description: 'Generate guided video from image and text.', providers: ['genx', 'huggingface'], executableEndpoint: null, status: 'provider_available_not_wired', blocker: 'No source-image video adapter is wired for the remaining launch providers.', requiredScope: 'ai:video:execute', exposeToConnectedAppsV1: false, createsArtifact: true, longRunning: true }),
  capability({ id: 'text_to_video', label: 'Text to Video', group: 'video', inputTypes: ['text'], outputTypes: ['video'], description: 'Start a real text-to-video provider job and persist completed output.', providers: ['genx', 'together', 'huggingface'], executableProviders: ['genx', 'together'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/video-generate', status: 'working', blocker: null, requiredScope: 'ai:video:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: true }),
  capability({ id: 'video_to_video', label: 'Video to Video', group: 'video', inputTypes: ['video', 'text'], outputTypes: ['video'], description: 'Transform an existing video.', providers: ['genx'], executableEndpoint: null, status: 'provider_available_not_wired', blocker: 'No source-video upload and transformation adapter is wired for the remaining launch providers.', requiredScope: 'ai:video:execute', exposeToConnectedAppsV1: false, createsArtifact: true, longRunning: true }),
  capability({ id: 'video_text_to_text', label: 'Video and Text to Text', group: 'multimodal', inputTypes: ['video', 'text'], outputTypes: ['text'], description: 'Analyze a video with a text instruction.', providers: ['genx', 'mimo', 'huggingface'], executableEndpoint: null, status: 'provider_available_not_wired', blocker: 'No video ingestion and analysis contract is wired.', requiredScope: 'ai:video:execute', exposeToConnectedAppsV1: false, createsArtifact: false, longRunning: true }),
  ...
  capability({ id: 'text_to_speech', label: 'Text to Speech', group: 'audio', inputTypes: ['text', 'voice'], outputTypes: ['audio'], description: 'Synthesize speech and persist the audio artifact.', providers: ['mimo', 'together', 'groq', 'genx', 'huggingface'], executableProviders: ['mimo', 'together', 'groq', 'genx', 'huggingface'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/tts', status: 'working', blocker: null, requiredScope: 'ai:audio:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: false }),
  capability({ id: 'automatic_speech_recognition', label: 'Automatic Speech Recognition', group: 'audio', inputTypes: ['audio'], outputTypes: ['transcript'], description: 'Transcribe uploaded audio and persist the transcript.', providers: ['genx', 'groq', 'together', 'huggingface', 'mimo'], executableProviders: ['genx', 'groq', 'together', 'huggingface', 'mimo'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/stt', status: 'working', blocker: null, requiredScope: 'ai:audio:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: false }),
  ...
  capability({ id: 'music_generation', label: 'Music Generation', group: 'music', inputTypes: ['text', 'lyrics', 'style'], outputTypes: ['music'], description: 'Generate playable music audio and persist it as an artifact.', providers: ['genx', 'huggingface'], executableProviders: ['genx'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/admin/music-studio', status: 'working', blocker: null, requiredScope: 'ai:music:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: true }),
  ...
  capability({ id: 'avatar_generation', label: 'Avatar Generation', group: 'avatar_voice', inputTypes: ['text'], outputTypes: ['avatar'], description: 'Create and persist a reusable avatar image.', providers: ['genx', 'huggingface', 'together'], executableProviders: ['genx', 'huggingface', 'together'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/avatar', status: 'working', blocker: null, requiredScope: 'ai:avatar:execute', exposeToConnectedAppsV1: false, createsArtifact: true, longRunning: false }),
