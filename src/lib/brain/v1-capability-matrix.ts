...
export const AI_CAPABILITY_TAXONOMY: readonly AiCapabilityDefinition[] = [
  ...
  capability({ id: 'text_to_video', label: 'Text to Video', group: 'video', inputTypes: ['text'], outputTypes: ['video'], description: 'Start a real text-to-video provider job and persist completed output.', providers: ['genx', 'qwen', 'together', 'huggingface'], executableProviders: ['genx', 'qwen', 'together'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/video-generate', status: 'working', blocker: null, requiredScope: 'ai:video:execute', exposeToConnectedAppsV1: true, createsArtifact: true, longRunning: true }),
  ...
  capability({ id: 'avatar_generation', label: 'Avatar Generation', group: 'avatar_voice', inputTypes: ['text'], outputTypes: ['avatar'], description: 'Create and persist a reusable avatar image.', providers: ['genx', 'huggingface', 'qwen', 'together'], executableProviders: ['genx', 'huggingface', 'qwen', 'together'], providerRouteSource: 'media_capability_registry', executableEndpoint: '/api/brain/avatar', status: 'working', blocker: null, requiredScope: 'ai:avatar:execute', exposeToConnectedAppsV1: false, createsArtifact: true, longRunning: false }),
