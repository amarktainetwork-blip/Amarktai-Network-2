...
export const CAPABILITY_MODEL_POOLS: readonly CapabilityModelPool[] = [
  ...
  },
  {
    ...
    blockedLowQualityCandidates: [],
    adultOnlyCandidates: [],
    requiredEnv: ['HF_ENDPOINT_IMAGE_EDIT or HF_SPECIALIST_ENDPOINTS_JSON for HF specialist route'],
    requiresArtifact: true,
    requiresJobPolling: false,
    productionReady: false,
    qualityStatus: 'source_wired_unproven',
  ...
  },
  {
    ...
    requiredEnv: ['TOGETHER_VIDEO_RUNTIME_ENABLED and TOGETHER_VIDEO_BASE_URL for Together', 'HF_ENDPOINT_IMAGE_TO_VIDEO or HF_SPECIALIST_ENDPOINTS_JSON for HF'],
    requiresArtifact: true,
  ...
  },
  {
    ...
    blockedLowQualityCandidates: [],
    adultOnlyCandidates: [],
    requiredEnv: ['HF_ENDPOINT_MUSIC_GENERATION or HF_SPECIALIST_ENDPOINTS_JSON for HF'],
    requiresArtifact: true,
    requiresJobPolling: true,
    productionReady: false,
    qualityStatus: 'blocked',
  ...
  },
  {
    ...
    blockedLowQualityCandidates: [],
    adultOnlyCandidates: [],
    requiredEnv: ['HF_ENDPOINT_TTS or HF_SPECIALIST_ENDPOINTS_JSON for HF'],
    requiresArtifact: true,
    requiresJobPolling: false,
    productionReady: true,
    qualityStatus: 'production_ready',
  ...
  },
  {
    ...
    blockedLowQualityCandidates: [],
    adultOnlyCandidates: [],
    requiredEnv: ['HF_ENDPOINT_STT or HF_SPECIALIST_ENDPOINTS_JSON for HF'],
    requiresArtifact: true,
    requiresJobPolling: true,
    productionReady: true,
    qualityStatus: 'production_ready',
  ...
  },
  {
    ...
    requiredEnv: ['TOGETHER_VIDEO_RUNTIME_ENABLED and TOGETHER_VIDEO_BASE_URL for Together', 'HF_ENDPOINT_TEXT_TO_VIDEO or HF_SPECIALIST_ENDPOINTS_JSON for HF'],
    requiresArtifact: true,
    requiresJobPolling: true,
    productionReady: false,
    qualityStatus: 'blocked',
