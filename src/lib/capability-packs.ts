...
const CAPABILITY_PACKS: Map<string, CapabilityPack> = new Map([
  [
    'support_pack',
    {
      ...
      allowedProviders: ['genx', 'groq', 'qwen'],
      recommendedModels: ['gpt-5.4-mini', 'llama-3.3-70b-versatile'],
      safetyLevel: 'strict',
  ...
  [
    'creator_pack',
    {
      ...
      allowedProviders: ['genx', 'qwen', 'together'],
      recommendedModels: ['gpt-5.4-mini', 'qwen-plus'],
  ...
  [
    'knowledge_pack',
    {
      ...
      allowedProviders: ['genx', 'qwen', 'groq'],
      recommendedModels: ['gpt-5.4-mini', 'qwen-plus'],
      safetyLevel: 'strict',
  ...
  [
    'media_pack',
    {
      ...
      allowedProviders: ['genx', 'together', 'qwen'],
      recommendedModels: ['gpt-5.4-mini', 'qwen-plus'],
      safetyLevel: 'standard',
  ...
  [
    'dev_pack',
    {
      ...
      allowedProviders: ['genx', 'qwen', 'groq', 'together'],
      recommendedModels: ['gpt-5.4-mini', 'qwen-plus'],
      safetyLevel: 'relaxed',
  ...
  [
    'adult_18plus_pack',
    {
      ...
      allowedProviders: ['genx', 'together'],
