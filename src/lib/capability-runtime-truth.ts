...
const CAPABILITY_SPECS: CapabilitySpec[] = [
  // ── Text / Chat ──────────────────────────────────────────────────────────
  {
    ...
    label: 'Text / Chat',
    category: 'text',
    providerCandidates: ['genx', 'groq', 'together', 'mimo', 'huggingface'],
  ...
  },
  {
    ...
    category: 'text',
    providerCandidates: ['genx', 'groq', 'together', 'mimo'],
  ...
  },
  {
    ...
    label: 'Embeddings',
    category: 'text',
    providerCandidates: ['huggingface', 'genx', 'together'],
  ...
  // ── Image ────────────────────────────────────────────────────────────────
  {
    ...
    category: 'image',
    providerCandidates: ['genx', 'together', 'huggingface'],
  ...
  },
  {
    ...
    label: 'Image Edit',
    category: 'image',
    providerCandidates: ['genx', 'together'],
  ...
  },
  {
    ...
    category: 'video',
    providerCandidates: ['genx', 'huggingface'],
    executionRoute: '/api/brain/video-generate',
    requiresStorage: true,
    requiresAdultGate: false,
    requiresDedicatedEndpoint: false,
  },
  {
    ...
    category: 'video',
    providerCandidates: ['genx'],
    executionRoute: '/api/brain/video',
    requiresStorage: true,
    requiresAdultGate: false,
    requiresDedicatedEndpoint: false,
  },
