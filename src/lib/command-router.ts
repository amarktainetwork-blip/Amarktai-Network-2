...
const RULES: Array<{
  ...
  command('create_song', [/song|music|lyrics|track|album|genre/i], 'Studio', 'content-studio',
  ...
  command('create_movie', [/movie|film|video|storyboard|scene|clip/i], 'Studio', 'content-studio',
    ['Movie Director Agent', 'Media Director Agent'], ['GenX video first', 'Replicate/Fal fallback', 'ffmpeg final render'],
  ...
  command('create_voice', [/voice|speech|tts|narrat|audio read/i], 'Studio', 'content-studio',
  ...
  command('create_image', [/image|picture|illustration|logo|poster|photo/i], 'Studio', 'content-studio',
    ['Media Director Agent'], ['GenX image first', 'Hugging Face/Together/Replicate/Fal fallback'],
  ...
  command('create_pr', [/create|open|raise].*(pr|pull request)|pull request/i], 'Workbench', 'app-builder',
  ...
  command('audit_repo', [/audit.*repo|review.*repo|what.*missing|codebase audit/i], 'Workbench', 'app-builder',
  ...
  command('monitor_vps', [/vps|server|cpu|memory|disk|nginx|systemd|ssl/i], 'System', 'operations',
  ...
  command('check_app_status', [/app status|is .* healthy|connected app|health check/i], 'Network Apps', 'operations',
  ...
  command('repair_connected_app', [/repair.*app|restart.*app|app.*broken/i], 'Network Apps', 'operations',
  ...
  command('create_marketing_campaign', [/marketing|campaign|ads|launch content/i], 'Network Apps', 'marketing',
  ...
  command('run_crypto_analysis', [/crypto|bitcoin|ethereum|trading|market analysis/i], 'Network Apps', 'crypto-trading',
  ...
  command('automate_workflow', [/automat|workflow|schedule|when .* then/i], 'Network Apps', 'automation-hub',
  ...
  command('generate_file', [/generate|create|write].*(file|document|csv|json|report)/i], 'Command', 'operations',
