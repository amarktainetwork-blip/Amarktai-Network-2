...
const RULES: Array<{
  ...
  command('create_movie', [/movie|film|video|storyboard|scene|clip/i], 'Studio', 'content-studio',
    ['Movie Director Agent', 'Media Director Agent'], ['GenX video first', 'Together fallback', 'ffmpeg final render'],
  ...
  command('create_image', [/image|picture|illustration|logo|poster|photo/i], 'Workspace', 'content-studio',
    ['Media Director Agent'], ['GenX image first', 'Together/Hugging Face fallback'],
  ...
  command('run_crypto_analysis', [/crypto|bitcoin|ethereum|trading|market analysis/i], 'Workspace', 'crypto-trading',
    ['Crypto/Trading Agent', 'Research Agent', 'Security Agent'], ['GenX reasoning', 'approved market data'], ['analysis report', 'risk scenarios'],
