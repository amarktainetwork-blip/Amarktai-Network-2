...
export const DASHBOARD_NAV_ITEMS: readonly DashboardNavItem[] = [
  ...
  { id: 'studio', href: '/admin/dashboard/studio', label: 'Studio', description: 'Create media through AmarktAI capabilities.', icon: Sparkles },
  { id: 'capabilities', href: '/admin/dashboard/capabilities', label: 'Capabilities', description: 'Browse the canonical V1 capability catalog.', icon: Shapes },
