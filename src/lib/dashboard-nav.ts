...
export const DASHBOARD_NAV_ITEMS: readonly DashboardNavItem[] = [
  ...
  { id: 'capabilities',         href: '/admin/dashboard/capabilities',  label: 'Capabilities',          description: 'Capability readiness, proof, route coverage, and runtime gates.', icon: Blocks,          group: 'Control' },
