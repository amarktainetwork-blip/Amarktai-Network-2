...
export const PLATFORM_ROUTE_TRUTH: readonly PlatformRouteTruth[] = [
  {
    ...
    purpose: 'The nine final dashboard sections.',
    auth: 'admin_session',
    status: 'KEEP',
    nextAction: 'Keep duplicate UI routes deleted; backend routes remain internal when still required by runtime.',
  },
  {
  ...
  },
  {
    ...
    auth: 'admin_session',
    status: 'KEEP',
    nextAction: 'Keep app, agent, and profile UI merged into Apps and Studio.',
  },
  {
