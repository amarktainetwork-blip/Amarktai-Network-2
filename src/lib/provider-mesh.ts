...
export const PROVIDER_MESH: readonly ProviderMeshNode[] = [
  {
    ...
    capabilities: ['text', 'streaming_text', 'reasoning', 'code', 'vision', 'image', 'video', 'image_to_video', 'music', 'audio', 'tts', 'stt', 'files', 'sessions', 'async_jobs', 'tools'],
  ...
  },
  {
    ...
    capabilities: ['text', 'streaming_text', 'reasoning', 'code', 'vision', 'tools', 'web_search'],
    testRoute: '/api/admin/settings/test-provider',
    normalUserVisible: false,
    settingsVisible: true,
    systemVisible: true,
  ...
  },
  {
    ...
    authMethod: 'Bearer token',
    capabilities: ['text', 'streaming_text', 'reasoning', 'code', 'vision', 'tts', 'stt', 'tools'],
    testRoute: '/api/admin/settings/test-provider',
    normalUserVisible: false,
    settingsVisible: true,
    systemVisible: true,
  ...
  },
  {
    ...
    authMethod: 'Bearer token',
    capabilities: ['text', 'streaming_text', 'reasoning', 'code', 'vision', 'embeddings', 'rerank', 'image', 'tools'],
    testRoute: '/api/admin/settings/test-provider',
    normalUserVisible: false,
    settingsVisible: true,
    systemVisible: true,
