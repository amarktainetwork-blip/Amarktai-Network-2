...
export const PROVIDER_TRUTH: readonly ProviderTruthDefinition[] = [
  ...
  },
  {
    ...
    capabilities: ['chat', 'reasoning', 'coding', 'image', 'video', 'image_to_video', 'music', 'tts', 'stt', 'avatar', 'vision', 'documents', 'agents'],
    features: {
      streaming: true,
      asyncJobs: true,
      webhooks: true,
  ...
  },
  {
    ...
    capabilities: ['chat', 'reasoning', 'coding', 'vision', 'tts', 'stt', 'voice_clone'],
    features: {
      streaming: true,
      asyncJobs: false,
      webhooks: false,
